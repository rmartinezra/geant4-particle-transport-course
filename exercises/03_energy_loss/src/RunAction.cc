...
void RunAction::EndOfRunAction(const G4Run* aRun)
{
  ...
  // Machine-readable G4EmCalculator reference, deliberately evaluated only
  // after all simulated events in this run have completed.
  G4cout << "COURSE_EM_REFERENCE total_dedx_MeV_cm="
         << emCal.ComputeTotalDEDX(ePrimary,particle,material)/(MeV/cm)
         << " csda_range_cm=" << emCal.GetCSDARange(ePrimary,particle,material)/cm
         << G4endl;
