...
void HistoManager::Book()
{
  ...
  analysisManager->CreateNtuple("hadronic", "First relevant nuclear interaction or escape");
  ...
  analysisManager->CreateNtupleDColumn("number_density_cm3");
  analysisManager->CreateNtupleDColumn("path_length_cm");
  analysisManager->CreateNtupleIColumn("interacted");
  analysisManager->CreateNtupleIColumn("escaped");
  analysisManager->CreateNtupleSColumn("process_name");
  analysisManager->FinishNtuple();
  analysisManager->SetNtupleFileName(0, "hadronic_native.csv");
}
